...
# SoleSlicer NP Status

This repository is the public working fork for `SoleSlicer NP`.

Current project direction:

- base code: `OrcaSlicer v2.3.1`
- target runtime: Linux CLI in Docker
- target feature: ZAA / Z contouring support
- repository plan: [dev_plan.md](dev_plan.md)
- port notes: [docs/zaa-port-notes.md](docs/zaa-port-notes.md)
- bootstrap notes: [docs/bootstrap.md](docs/bootstrap.md)

Project-specific rule:

- prioritize CLI and Docker deliverables first;
- treat desktop UI work as secondary unless required by the build.
