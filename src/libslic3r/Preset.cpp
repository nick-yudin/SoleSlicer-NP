...
static std::vector<std::string> s_Preset_print_options {
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "gcode_add_line_number", "enable_arc_fitting", "precise_z_height", "zaa_enabled", "zaa_minimize_perimeter_height", "zaa_dont_alternate_fill_direction", "zaa_min_z", "zaa_region_disable", "infill_combination","infill_combination_max_layer_height", /*"adaptive_layer_height",*/
